package network.tos.ledger.ble
...
import network.tos.ledger.ble.callback.BleManagerConnectionCallback
import network.tos.ledger.ble.callback.BleManagerDisconnectionCallback
import network.tos.ledger.ble.callback.BleManagerSendCallback
import network.tos.ledger.ble.extension.fromHexStringToBytes
import network.tos.ledger.ble.model.BleDeviceModel
import network.tos.ledger.ble.model.BleError
import network.tos.ledger.ble.model.BleEvent
import network.tos.ledger.ble.model.BleState
import network.tos.ledger.ble.service.BleService
import network.tos.ledger.ble.service.model.BleServiceEvent
...
class BleManager internal constructor(
    ...
    private fun internalStartScanning(): Boolean {
        ...
        //Filter Europe service
        filters.add(
            ScanFilter.Builder()
                .setServiceUuid(ParcelUuid(UUID.fromString(EUROPA_SERVICE_UUID)))
                .build()
        )
    ...
    companion object {
        ...
        const val EUROPA_SERVICE_UUID = "13d63400-2c97-3004-0000-4c6564676572"
        ...
        const val europaNotifyCharacteristicUUID = "13d63400-2c97-3004-0001-4c6564676572"
        const val europaWriteWithResponseCharacteristicUUID = "13d63400-2c97-3004-0002-4c6564676572"
        const val europaWriteWithoutResponseCharacteristicUUID =
