...
import network.tos.extensions.getUserMessage
import network.tos.extensions.shortTron
import network.tos.extensions.uri
import network.tos.icu.Coins
import network.tos.icu.Coins.Companion.isPositive
...
import network.tos.wallet.app.extensions.clipboardText
...
import network.tos.wallet.app.ui.component.coin.CoinInputView
import network.tos.wallet.app.ui.screen.camera.CameraMode
...
import network.tos.wallet.app.ui.screen.send.main.SendEvent
...
import network.tos.wallet.localization.Plurals
...
class SendScreen(wallet: WalletEntity) : WalletContextScreen(R.layout.fragment_send, wallet),
    ...
    private fun setSuccess() {
        ...
        navigation?.openURL("tos://activity?from=send")
