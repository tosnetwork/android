package network.tos.wallet.app.ui.screen.onramp.main.view
...
import network.tos.uikit.flag.getFlagDrawable
...
class CurrencyInputView @JvmOverloads constructor(
    ...
    fun setInsufficientBalance() {
        ...
        tokenBalanceView.setTextColor(context.resolveColor(network.tos.uikit.color.R.attr.accentRedColor))
    ...
    private fun showTokenBalance(value: Coins) {
        tokenBalanceView.setTextColor(context.resolveColor(network.tos.uikit.color.R.attr.textSecondaryColor))
        tokenBalanceView.visibility = View.VISIBLE
