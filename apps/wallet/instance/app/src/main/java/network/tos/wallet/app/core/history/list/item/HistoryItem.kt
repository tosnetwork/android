package network.tos.wallet.app.core.history.list.item
...
import network.tos.extensions.readBooleanCompat
import network.tos.extensions.readCharSequenceCompat
import network.tos.extensions.readEnum
import network.tos.extensions.readParcelableCompat
import network.tos.extensions.writeBooleanCompat
import network.tos.extensions.writeCharSequenceCompat
import network.tos.extensions.writeEnum
import network.tos.wallet.app.core.history.ActionOutStatus
...
import network.tos.wallet.data.dapps.entities.AppPushEntity
import network.tos.wallet.data.events.ActionType
import network.tos.wallet.data.events.recipient
import network.tos.wallet.data.events.sender
