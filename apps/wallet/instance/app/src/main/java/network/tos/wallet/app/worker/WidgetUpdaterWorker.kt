...
import network.tos.extensions.circle
import network.tos.extensions.isLocal
...
import network.tos.wallet.app.extensions.loadDrawable
import network.tos.wallet.app.extensions.setOnClickIntent
import network.tos.wallet.app.manager.assets.AssetsManager
import network.tos.wallet.app.manager.widget.WidgetEntity
import network.tos.wallet.app.manager.widget.WidgetManager
import network.tos.wallet.app.manager.widget.WidgetParams
...
class WidgetUpdaterWorker(
    ...
    private suspend fun updateRateWidget(
        ...
        removeView.setOnClickIntent(context, android.R.id.background, Uri.parse("tos://token/$jettonAddress"))
    ...
    private suspend fun updateBalanceWidget(
        ...
        removeView.setOnClickIntent(context, android.R.id.background, Uri.parse("tos://pick/$walletId"))
