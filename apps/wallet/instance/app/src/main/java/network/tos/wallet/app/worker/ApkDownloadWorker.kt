...
import network.tos.wallet.app.helper.NotificationsHelper
import network.tos.wallet.api.API
import network.tos.wallet.api.FileDownloader
import network.tos.wallet.api.FileDownloader.DownloadStatus
...
class ApkDownloadWorker(
    ...
    private fun showInstallNotification(file: File) {
        val installUri = "tos://install".toUri()
            .buildUpon()
    ...
    private fun notificationBuilder(): NotificationCompat.Builder {
        ...
        val contentIntent = NotificationsHelper.getPendingIntent(context, "tos://wallet")
